  ...
  return (
    <div>
       <div  className="page-section">
            ...
            <h2>About Me</h2>
            <div>
            <img src="./src/images/avatar.jpg" alt="profile" style={{width: '100px', height: '100px'}}/>
            ...
            <nav>
                ...
                <img src="./src/images/github.png" alt="Github" style={{width: '50px', height: '50px'}}/>
                </a>
                <a href="#">
                <img src="./src/images/link.png" alt="linkedin" style={{width: '50px', height: '50px'}}/>
                </a>
            </nav>
